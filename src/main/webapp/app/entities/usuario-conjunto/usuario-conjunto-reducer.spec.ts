...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USUARIOCONJUNTO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_USUARIOCONJUNTO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_USUARIOCONJUNTO actions', async () => {
      const arg = { id: '8e0b125d-5063-4cf7-8a5d-68ce3052afcc' };
    ...
    it('dispatches UPDATE_USUARIOCONJUNTO actions', async () => {
      const arg = { id: '8e0b125d-5063-4cf7-8a5d-68ce3052afcc' };
    ...
    it('dispatches PARTIAL_UPDATE_USUARIOCONJUNTO actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_USUARIOCONJUNTO actions', async () => {
      const arg = 42666;
